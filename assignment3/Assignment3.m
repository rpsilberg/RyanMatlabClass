...
% THIRD MOVE: Player 1 (Includes check for move availability)
...
% FIFTH MOVE: Player 1 (Includes check for move availability)
...
% SEVENTH MOVE: Player 1 (Includes check for move availability)
...
% NINTH MOVE: Player 1 (Includes check for move availability)
                player_move5 = input('Player 1 Move 5 (1 through 9): ','s')   
                if (player_move5 == '1')
                    if (ticTacToe(1,1) == -1)
                        disp('Invalid Move, Lose Turn')
                    elseif (ticTacToe(1,1) == 0)
