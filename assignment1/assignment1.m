...
%
% Answer: Remove items from MATLAB workspace and reset MuPAD engine
%
...
%
% Answer: While loops and for loops. While loops repeat as long as the
%         stated condition remains true and for loops repeat for a
...
%
% Answer: NaN stands for Not-a-Number. Example: 0*Inf
%
